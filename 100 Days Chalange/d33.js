...
function daysUntilNewYear() {
    ...
    var diff = newYear.getTime() - Today.getTime(); // diference in millisecond
    var convertingIntoDays = Math.ceil(diff / (1000 * 60 * 60 * 24));
    //*Here I acces the access the "diff" and then converting miiliseconds into days, via math.ceil.
    return convertingIntoDays;
}
// Finally log the results .
console.log("".concat(daysUntilNewYear(), " days untill the next year."));
